---
name: setup
description: Interactive setup wizard for codecrib - choose vector DB and collection mode
arguments: []
---
...
Based on answers, create/update `codecrib.local.md`:
...
`plugins/codecrib/codecrib.local.md`
